...
Сначала даётся номер квартала с двоеточием,
а после — маркированный список с дефисом с названием товара и с количеством продаж через двоеточие.
Кварталы идут по порядку, а товары внутри квартала сортируются по алфавиту.
Пример 1
Входные данные:
2023-01-15:Книга:10;
2023-04-20:Флешка:5;
2023-07-05:Наушники:8
Выходные данные:
Q1: - Книга: 10
Q2: - Флешка: 5
Q3: - Наушники: 8
...
2023-02-05:Шляпа:4;
2023-03-20:Кольцо:7;
2023-04-25:Браслет:6;
2023-04-26:Браслет:12
Выходные данные:
Q1:
- Кольцо: 7
- Шляпа: 4
...
def generate_quarterly_report(data: list[str]) -> list[str]:
    new_dict = {}
    list_data = [x.split(":") for x in data]
    for item in list_data:

        if list_data[0].quarter == "Q1":

    return month


input_data = ['2023-01-15:Книга:10;', '2023-04-20:Флешка:5;', '2023-07-05:Наушники:8']
